...
func NewServer(config *Config) *Server {
	...
	s := newServer(ioutils.NewStdStream(), log, config.Debug, config.Addr, config.ClientStrategy, config.DirectNeighbors, config.PrintReadAck, networkInterface, config.SlowdownMs)
	s.ownsNetwork = true
